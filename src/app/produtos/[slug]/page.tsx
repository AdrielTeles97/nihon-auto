  ...
  useEffect(() => {
    const loadProduct = async () => {
      ...
      try {
        ...
        setError('Produto não encontrado ou erro ao carregar do WordPress.');
        ...
        const mockProducts: Product[] = [
    {
      ...
      description: "Espuma para limpeza automotiva com fórmula avançada que remove sujeira, gordura e resíduos sem danificar a pintura. Produto desenvolvido especialmente para detalhamento automotivo profissional.",
      price: 29.90,
    ...
    },
    {
      ...
      description: "Kit completo para detalhamento automotivo com produtos profissionais da 3M.",
      price: 159.90,
      image: "/placeholder-product.svg",
      category: "Kits",
      brand: "3M",
          ...
          <div className="space-y-6">
            ...
            <div className="relative group">
              <div className="aspect-square bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl overflow-hidden border border-gray-200 shadow-lg max-w-lg mx-auto lg:mx-0 relative">
                ...
                <div className="absolute bottom-4 right-4 bg-white/90 backdrop-blur-sm p-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                  <span className="text-xs text-gray-600 font-medium">🔍 Clique para ampliar</span>
                </div>
              </div>
            </div>
            ...
            {images.length > 1 && (
              <div className="space-y-3">
                <h4 className="text-sm font-medium text-gray-700 text-center lg:text-left">Mais imagens</h4>
            ...
            <div className="flex items-center justify-center lg:justify-start space-x-3">
              <Button variant="outline" size="sm" className="text-gray-600 hover:text-red-600 border-gray-300">
                <Heart className="w-4 h-4 mr-2" />
                Favoritar
              </Button>
              <Button variant="outline" size="sm" className="text-gray-600 hover:text-red-600 border-gray-300" onClick={handleShare}>
          ...
          <div className="bg-gradient-to-r from-red-600 to-red-700 rounded-xl p-6 text-white mb-8 shadow-lg">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="flex-1 mb-4 md:mb-0">
                <h3 className="text-xl font-bold mb-2">🚚 Frete Grátis para Todo o Brasil</h3>
                <p className="text-red-100">Em compras acima de R$ 299,00 • Entrega expressa disponível</p>
              </div>
              <div className="flex items-center space-x-4">
                <div className="text-center">
                  <div className="text-2xl font-bold">24h</div>
                  <div className="text-xs text-red-200">Envio Rápido</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold">30d</div>
                  <div className="text-xs text-red-200">Garantia</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div>
              <div className="flex items-center mb-2">
                <Badge variant="outline" className="bg-red-50 text-red-700 border-red-200">{product.category}</Badge>
              </div>
              
              <h1 className="text-3xl font-bold text-gray-900 mb-2">{product.name}</h1>
              
              {product.brand && (
                <p className="text-lg text-gray-600 mb-4">Marca: <span className="font-semibold">{product.brand}</span></p>
              )}
            ...
            <div>
              ...
              {product.inStock ? (
                <Badge className="bg-green-100 text-green-800 border-green-200">Em estoque</Badge>
              ) : (
            ...
            <CardContent className="p-8">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {Object.entries(product.specifications).map(([key, value], index) => (
                          <div key={key} className="bg-gradient-to-br from-white to-gray-50 border border-gray-200 rounded-xl p-6 hover:border-red-300 hover:shadow-lg transition-all duration-300 group">
                            <div className="flex flex-col space-y-3">
                              <div className="flex items-center space-x-2">
                                <div className="w-3 h-3 bg-red-600 rounded-full group-hover:scale-110 transition-transform duration-300"></div>
                                <span className="text-sm font-bold text-gray-500 uppercase tracking-wider">{key}</span>
                              </div>
                              <span className="text-xl font-bold text-gray-800 group-hover:text-red-600 transition-colors duration-300">{value}</span>
                            </div>
                    ...
                    <div className="mt-12">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {product.features.map((feature, index) => (
                          <div key={index} className="flex items-center space-x-4 p-4 bg-gradient-to-r from-gray-50 to-white rounded-xl border border-gray-200 hover:border-red-300 hover:shadow-md transition-all duration-300 group">
                            <div className="w-3 h-3 bg-red-600 rounded-full flex-shrink-0 group-hover:scale-125 transition-transform duration-300"></div>
                            <span className="text-gray-700 font-semibold group-hover:text-red-600 transition-colors duration-300">{feature}</span>
                          </div>
                        ))}
                      </div>
                    </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="prose prose-lg max-w-none">
                    <p className="text-gray-700 leading-relaxed text-lg">
                      {product.description || 'Este produto oferece qualidade excepcional e tecnologia avançada, proporcionando uma experiência única para o usuário. Desenvolvido com os mais altos padrões de qualidade, combina design elegante com funcionalidade superior.'}
                    </p>
                    <div className="mt-8 p-6 bg-gradient-to-r from-red-50 to-red-100 rounded-xl border-l-4 border-red-600">
                      <h4 className="text-xl font-bold text-gray-800 mb-3">Destaques do Produto</h4>
                      <ul className="space-y-2 text-gray-700">
                        ...
                        <li className="flex items-center space-x-3">
                          <div className="w-2 h-2 bg-red-600 rounded-full"></div>
                          <span>Design moderno e elegante</span>
                        </li>
                      </ul>
                    </div>
                  </div>
              ...
              {activeTab === 'reviews' && (
                <div className="space-y-8">
                  ...
                  <div className="bg-gradient-to-r from-red-50 to-red-100 rounded-xl p-8 border border-red-200">
                    <div className="flex items-center space-x-8">
                      <div className="text-center">
                        ...
                        <div className="text-gray-600 text-sm">Baseado em 127 avaliações</div>
                      </div>
                      <div className="flex-1 space-y-2">
                        {[5, 4, 3, 2, 1].map((rating) => (
                          <div key={rating} className="flex items-center space-x-3">
                            ...
                            <span className="text-sm text-gray-600 w-8">{rating === 5 ? 95 : rating === 4 ? 25 : rating === 3 ? 4 : rating === 2 ? 2 : 1}</span>
                          </div>
                        ))}
                      </div>
                    </div>
                  ...
                  <div className="space-y-6">
                    {[1, 2, 3].map((review) => (
                      <div key={review} className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow duration-300">
                        <div className="flex items-start space-x-4">
                          <div className="w-12 h-12 bg-red-600 rounded-full flex items-center justify-center text-white font-bold">
                            {review === 1 ? 'M' : review === 2 ? 'A' : 'J'}
                          </div>
                          <div className="flex-1">
                            <div className="flex items-center justify-between mb-2">
                              <h4 className="font-bold text-gray-800">
                                {review === 1 ? 'Maria Silva' : review === 2 ? 'André Costa' : 'João Santos'}
                              </h4>
                            ...
                            <p className="text-gray-700 mb-3">
                              {review === 1 
                                ? 'Produto excelente! Superou minhas expectativas em qualidade e design. Recomendo muito!'
                                : review === 2 
                                ? 'Muito satisfeito com a compra. Entrega rápida e produto conforme descrito.'
                                : 'Ótima qualidade e acabamento impecável. Vale cada centavo investido.'}
                            </p>
                            <div className="text-sm text-gray-500">
                              {review === 1 ? '2 dias atrás' : review === 2 ? '1 semana atrás' : '2 semanas atrás'}
                            </div>
                          </div>
                        </div>
                      </div>
      ...
      <div className="bg-gray-50 py-16 mt-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Produtos Relacionados</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">Descubra outros produtos que podem interessar você</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100">
              <div className="aspect-square bg-gray-100 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center">
                  <span className="text-gray-500 text-sm">Produto Relacionado</span>
                </div>
              </div>
              <div className="p-4">
                <h3 className="font-semibold text-gray-800 mb-2 line-clamp-2">Produto Relacionado 1</h3>
                <div className="flex items-center justify-between">
                  <span className="text-lg font-bold text-red-600">R$ 199,90</span>
                  <Button size="sm" className="bg-red-600 hover:bg-red-700">Ver</Button>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100">
              ...
              <div className="p-4">
                <h3 className="font-semibold text-gray-800 mb-2 line-clamp-2">Produto Relacionado 2</h3>
                <div className="flex items-center justify-between">
                  <span className="text-lg font-bold text-red-600">R$ 299,90</span>
                  <Button size="sm" className="bg-red-600 hover:bg-red-700">Ver</Button>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100">
              ...
              <div className="p-4">
                <h3 className="font-semibold text-gray-800 mb-2 line-clamp-2">Produto Relacionado 3</h3>
                <div className="flex items-center justify-between">
                  <span className="text-lg font-bold text-red-600">R$ 399,90</span>
                  <Button size="sm" className="bg-red-600 hover:bg-red-700">Ver</Button>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100">
              ...
              <div className="p-4">
                <h3 className="font-semibold text-gray-800 mb-2 line-clamp-2">Produto Relacionado 4</h3>
                <div className="flex items-center justify-between">
                  <span className="text-lg font-bold text-red-600">R$ 499,90</span>
                  <Button size="sm" className="bg-red-600 hover:bg-red-700">Ver</Button>
                </div>
              </div>
            </div>
