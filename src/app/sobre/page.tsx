        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl lg:text-6xl font-bold mb-6">
              Sobre a <span className="text-red-400">Montecarlo</span>
            </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-gray-600">
              <p className="mb-6">
                Fundada em 1986, a Montecarlo nasceu com o propósito de revolucionar o mercado de 
                acessórios automotivos no Brasil. Começamos como uma pequena distribuidora familiar 
              ...
              <p>
                ...
                mantendo nosso compromisso com a qualidade, inovação e atendimento personalizado 
                que nos tornou a escolha preferida de milhares de clientes em todo o país.
              </p>
            </div>
          </div>
        </div>
