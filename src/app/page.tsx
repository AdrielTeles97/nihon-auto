      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-5xl mx-auto">
          ...
          >
            ...
            >
              <Link href="/produtos">
                <Button size="lg" className="bg-red-600 hover:bg-red-700 text-white px-12 py-4 text-lg font-bold border-0 shadow-2xl rounded-xl">
                  Explorar Produtos
            ...
            >
              <Link href="/sobre">
                <Button size="lg" variant="outline" className="border-2 border-white bg-transparent text-white hover:bg-white hover:text-black px-12 py-4 text-lg font-bold rounded-xl shadow-2xl">
                  Nossa História
                </Button>
              </Link>
            </motion.div>
        ...
        <section className="py-20 bg-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative">
            ...
            >
              ...
              >
                <Link href="/produtos">
                  <Button size="lg" className="bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white px-10 py-4 text-lg font-semibold rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300">
                ...
                >
                  <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 group-hover:bg-red-50">
                    <motion.div 
                      ...
                      initial={{ scale: 0 }}
                      whileInView={{ scale: 1 }}
                      transition={{ duration: 0.6, delay: stat.delay + 0.2, type: "spring", bounce: 0.4 }}
                      viewport={{ once: true }}
                    >
                      {stat.number}
                    </motion.div>
      ...
      <ScrollReveal>
        <section className="py-20 bg-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                Por que escolher a <span className="text-red-600">Montecarlo?</span>
              </h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  description: 'Nossa equipe está pronta para ajudar você a escolher o produto ideal.',
                  delay: 0.3,
