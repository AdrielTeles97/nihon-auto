                        ...
                        <div className="text-center">
                            ...
                            >
                                ...
                                <p className="text-xl text-neutral-400 max-w-3xl mx-auto leading-relaxed">
                                    Paixão por carros e pela experiência de
                                    dirigir. Transformamos seu veículo em uma
                                    extensão perfeita do seu estilo e
                                    necessidades.
                                </p>
                            </motion.div>
                        </div>
                            ...
                            >
                                ...
                                <div className="space-y-6 text-neutral-300">
                                    ...
                                    <p className="text-lg leading-relaxed">
                                        ...
                                        até soluções de desempenho e estética,
                                        nossa missão é proporcionar o melhor
                                        para você e seu carro japonês.
                                    </p>
                                </div>
                                ...
                                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <p className="text-neutral-300 leading-relaxed">
                                            ...
                                            receber você com atendimento
                                            especializado e tirar todas as suas
                                            dúvidas sobre nossos produtos e
                                            serviços.
                                        </p>
                                    </div>
                                </div>
                            ...
                            >
                                <div className="bg-gradient-to-br from-red-600 to-red-800 rounded-2xl p-8 text-white">
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        >
                                            <Link
                                                href="https://wa.me/5591982337100"
                                                target="_blank"
