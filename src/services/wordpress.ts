...
// API Configuration
const WORDPRESS_BASE_URL = process.env.NEXT_PUBLIC_WORDPRESS_API_URL?.replace('/wp-json/wp/v2', '') || 'https://darksalmon-cobra-736244.hostingersite.com';
const WC_API_BASE_URL = process.env.NEXT_PUBLIC_WOOCOMMERCE_API_URL || 'https://darksalmon-cobra-736244.hostingersite.com/wp-json/wc/v3';
const WP_API_BASE_URL = process.env.NEXT_PUBLIC_WORDPRESS_API_URL || 'https://darksalmon-cobra-736244.hostingersite.com/wp-json/wp/v2';

// WooCommerce API credentials
const WC_CONSUMER_KEY = process.env.WOOCOMMERCE_CONSUMER_KEY || 'ck_cde4987447c3bd8dc0f1c1ec064a135f9e9dafef';
const WC_CONSUMER_SECRET = process.env.WOOCOMMERCE_CONSUMER_SECRET || 'cs_f9b40b5ecce45dbeb3fd0810a80cb8b90c115966';
