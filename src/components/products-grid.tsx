                ...
                {!loading && products.length === 0 ? (
                    <div className="text-center py-12">
                        <div className="text-gray-500 mb-4">
                            ...
                            >
                                <path
                                    ...
                                    strokeWidth={1}
                                    d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2 2v-5m16 0h-2M4 13h2m0 0V9a2 2 0 012-2h2m0 0V6a2 2 0 012-2h2.586a1 1 0 01.707.293l2.414 2.414a1 1 0 01.293.707V9a2 2 0 01-2 2h-2m0 0v2a2 2 0 002 2h2a1 1 0 001-1v-1a2 2 0 00-2-2h-2z"
                                />
                            </svg>
                        </div>
                        ...
                        {(searchTerm ||
                            ...
                            >
                                Limpar {searchTerm ? 'busca e ' : ''}filtros
                            </Button>
                        )}
                    </div>
                ) : (
